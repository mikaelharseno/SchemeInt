...
(quote (1 (20 twenty . (4 . 5))))
; expect (1 (20 twenty 4 . 5))

(car (quote (1 (20 twenty . (4 . 5)))))
; expect 1

(cdr (quote (1 (20 twenty . (4 . 5)))))
; expect ((20 twenty 4 . 5))
...
(begin (print 3) '(+ 2 3))
; expect (+ 2 3)
;;; found that the expext tests doesn't support print statements (it examines the return value)
...
(define (tail-call-test x y)
    (cond
        ((< x y) x)
        (else (tail-call-test (- x 3) y))
    )
)
(tail-call-test 7 2)
; expect 1
